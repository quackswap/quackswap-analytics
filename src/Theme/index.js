...
const theme = (darkMode, color) => ({
  ...
  quackswapBlue: darkMode ? '#50b2bc' : 'black',
  ...
  //primary colors
  primary1: darkMode ? '#2172E5' : '#50b2bc',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#50b2bc',

  // secondary colors
  secondary1: darkMode ? '#2172E5' : '#50b2bc',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #50b2bc30 0%, #fff 0%)`,
})
