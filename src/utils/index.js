...
// TODO fix link
const QUACKSWAP_LINK = "https://quackswap-interface-c64wh.ondigitalocean.app/"
...
export function getMiningPoolLink(token0Address) {
  return `${QUACKSWAP_LINK}/#/uni/ETH/${token0Address}`
}
...
export function getUniswapAppLink(linkVariable) {
  ...
  return `${baseUniswapUrl}/BTT/${linkVariable}`
}
